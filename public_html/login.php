...
<head>
  <?php
  $title = 'ログイン｜海外リゾキャバ求人.COM';
  $description = 'ログインページです。';
  $og_title = $title;
  $og_description = $description;
  $og_type = 'website';
  $og_url = 'https://resocaba-info.com/login/';
  $og_image = 'https://placehold.co/1200x630/0abab5/ffffff?text=Login';
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li class="flex items-center"><span class="text-gray-700 font-medium">ログイン</span></li>
            </ol>
          </nav>
          <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 mt-4">ログイン</h1>
        </div>
      </div>
