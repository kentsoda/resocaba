            ...
            <section id="pickup-jobs" class="job-section">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="text-center mt-8 px-4 sm:px-6 lg:px-8">
                        <a href="/jobs/?section=pickup" class="inline-block px-8 py-3 text-sm font-semibold text-white bg-[var(--brand-primary)] hover:bg-opacity-80 transition-all shadow-lg">もっと見る</a>
                    </div>
                </div>
            </section>
