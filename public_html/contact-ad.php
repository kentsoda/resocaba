...
<head>
  <?php
  $title = '広告掲載について｜海外リゾキャバ求人.COM';
  $description = '広告掲載に関するお問い合わせページです。';
  $og_title = $title;
  $og_description = $description;
  $og_type = 'website';
  $og_url = 'https://resocaba-info.com/contact-ad/';
  $og_image = 'https://placehold.co/1200x630/0abab5/ffffff?text=Contact+Ad';
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li class="flex items-center"><span class="text-gray-700 font-medium">広告掲載</span></li>
            </ol>
          </nav>
          <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 mt-4">広告掲載について</h1>
        </div>
      </div>
