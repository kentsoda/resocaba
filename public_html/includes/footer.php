        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class="md:col-span-2 lg:col-span-4">
                ...
                <p class="text-xs text-slate-400 mt-4 leading-relaxed">
                    新しい働き方、見つけよう。国内外のリゾートバイト・ワーキングホリデーの求人情報サイト。
                </p>
                <div class="flex space-x-4 mt-6">
                    <a href="#" class="text-slate-400 hover:text-white" aria-label="Twitter"><i data-lucide="twitter"></i></a>
            ...
            <div class="md:col-span-2 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
                <div>
                    ...
                    <ul class="space-y-3 text-xs">
                        <li><a href="/for-beginners/" class="hover:text-white transition-colors">初めての方</a></li>
                        <li><a href="/jobs/" class="hover:text-white transition-colors">求人検索</a></li>
                        <li><a href="/announcements/" class="hover:text-white transition-colors">お知らせ</a></li>
