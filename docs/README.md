...
実装タスクの詳細な一覧。管理画面改修、バックエンド処理、フロントエンド更新、テスト・移行の4つのカテゴリに分類された具体的なタスク。

### new_tasks_2025-11-06.md
新規追加された実装タスクの一覧。求人カードタグ表示、ユーザーログイン機能、新規登録機能の開発計画。
...
### phase7_final_impact_audit.md
最終調整の影響範囲監査メモ。リンク統一とダミーJS残存の確認結果。
